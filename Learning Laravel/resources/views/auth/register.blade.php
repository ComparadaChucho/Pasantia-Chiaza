<x-layout>
    ...
    <form method="POST" action="/register">
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            <a  href="/" type="button" class="rounded-md text-sm font-semibold leading-6 text-gray-900 outline-none focus-visible:outline-offset-5 focus-visible:outline-gray-900">Cancel</a>
